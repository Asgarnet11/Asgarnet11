...
<p align="center">
  <picture>
    <source media="(max-width: 760px) and (prefers-color-scheme: dark)" srcset="./assets/hero/agent-console-051d194e-mobile-dark.svg">
    <source media="(max-width: 760px)" srcset="./assets/hero/agent-console-051d194e-mobile-light.svg">
    <source media="(prefers-color-scheme: dark)" srcset="./assets/hero/agent-console-051d194e-dark.svg">
    <source media="(prefers-color-scheme: light)" srcset="./assets/hero/agent-console-051d194e-light.svg">
    <img src="./assets/hero/agent-console-051d194e-dark.svg" alt="Your Name - AI Engineer & Product Builder" width="100%">
  </picture>
</p>
